...
static void MenuTestDrive()
{
    ...
    dinerMenu.Add(new MenuItem("Hot Dog Pancakes", "Pancakes made with fresh blueberries", true, 3.05));
    ...
    dessertMenu.Add(new MenuItem("Sorbet", "A scoop of raspberry and scoop of lime", true, 1.89));
